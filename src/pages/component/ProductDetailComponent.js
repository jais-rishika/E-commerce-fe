...
export default function ProductDetailComponent({
  ...
  return (
    <Container>
      <CartAlert showCartMessage={showCartMessage} setShowCartMessage={setShowCartMessage}/>
      <Row className="mt-5">
          ...
          <Row>
            ...
            <Col md={4}>
              <ListGroup>
                ...
                <ListGroup.Item>
                  <Button style={{cursor:"pointer"}} variant="danger" onClick={addToCartHandler}>Add to cart</Button>
                </ListGroup.Item>
              </ListGroup>
            </Col>
          </Row>
